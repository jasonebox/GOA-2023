# Glacirs of the Arctic (GOA) 2023
...
Russian High Arctic (RHI) is currently estimated based on regression with Svalbard from the 2000 to 2017 period after RHI data from:
